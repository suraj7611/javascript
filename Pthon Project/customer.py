...
class Cust_Win:
    def __init__(self,root):
        ...
        self.root.geometry("1180x550+180+185")
...
# --------------------------------Title------------------------------------------
        lbl_title = Label(self.root, text="ADD CUSTOMER DETAILS", font=("times new roman", 15), bg="black", fg="gold",
                          bd=4, relief=RIDGE)
...
# ----------------------------Lable Frmae----------------------------------
        ...
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Customer Details",padx=2,fg="orange",font=("arial", 12,"bold"))
...
#cust_ref
        ...
        entry_ref = ttk.Entry(labelframeleft,textvariable=self.var_cust_name, width=29, font=("arial", 12, "bold"))
        ...
        entry_ref = ttk.Entry(labelframeleft,textvariable=self.var_mother ,width=29, font=("arial", 12, "bold"))
        ...
        textPostCode = ttk.Entry(labelframeleft,textvariable=self.var_post, width=29, font=("arial", 12, "bold"))
        textPostCode.grid(row=4, column=1)

        # MobileNumber
        lblMobile = Label(labelframeleft, text="Mobile:", font=("arial", 12, "bold"), padx=2, pady=6)
        lblMobile.grid(row=5, column=0, sticky=W)
        textMobile = ttk.Entry(labelframeleft,textvariable=self.var_mobile ,width=29, font=("arial", 12, "bold"))
        textMobile.grid(row=5, column=1)

        # Email
        lblEmail = Label(labelframeleft, text="Email:", font=("arial", 12, "bold"), padx=2, pady=6)
        lblEmail.grid(row=6, column=0, sticky=W)
        textEmail = ttk.Entry(labelframeleft,textvariable=self.var_email ,width=29, font=("arial", 12, "bold"))
        ...
        combo_Nationality["value"] = ("Select","Indian", "American", "Britist")
        ...
        combo_id["value"] = ("Select","AadharCard", "PanCard", "DrivingLicence","Passport")
        combo_id.current(0)
        ...
        textIdNumber = ttk.Entry(labelframeleft,textvariable=self.var_id_number, width=29, font=("arial", 13, "bold"))
...
# ----------------------------Buttons-----------------------------
        ...
        Table_Frame = LabelFrame(self.root, bd=2, relief=RIDGE, text="View Details and Search System", padx=2,
                                    font=("arial", 12, "bold"))
        Table_Frame.place(x=435, y=40, width=745, height=490)
        ...
        textSerach = ttk.Entry(Table_Frame,textvariable=self.txt_search, width=20, font=("arial", 13, "bold"))
        textSerach.grid(row=0, column=2,padx=2)

        btnSearch = Button(Table_Frame,command=self.search, text="Search", font=("arial", 12, "bold"), bg="black", fg="gold", width=9)
        btnSearch.grid(row=0, column=3, padx=2)

        btnShowAll = Button(Table_Frame,command=self.fetch_data, text="Show All", font=("arial", 12, "bold"), bg="black", fg="gold", width=9)
        btnShowAll.grid(row=0, column=4, padx=2)

# ----------------------------------------Show data table---------------------------------------------

        details_Table = Frame(Table_Frame, bd=2, relief=RIDGE)
        details_Table.place(x=0, y=40, width=745, height=350)
    ...
    def update(self):
        if self.var_mobile.get()=="":
            ...
            self.fetch_data()
            conn.close()
            messagebox.showinfo("Updated","Customer detail has been update successfully",parent=self.root)
